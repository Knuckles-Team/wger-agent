...
# Paths
ROOT_DIR = '/home/apps/workspace/agent-packages/agents/wger-agent'
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in wger-agent
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in wger-agent but are NOT registered "
