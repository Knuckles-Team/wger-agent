...
Manual
  * [](https://wger.readthedocs.io/en/latest/manual/routines.html)
    * [Workout days](https://wger.readthedocs.io/en/latest/manual/routines.html#workout-days)
    * [Advancing through the routine](https://wger.readthedocs.io/en/latest/manual/routines.html#advancing-through-the-routine)
    * [Sets and exercises](https://wger.readthedocs.io/en/latest/manual/routines.html#sets-and-exercises)
    * [Progression rules](https://wger.readthedocs.io/en/latest/manual/routines.html#progression-rules)
...
[wger project](https://wger.readthedocs.io/en/latest/index.html)
  ...
  * Using the routines
  * [ Edit on GitHub](https://github.com/wger-project/docs/blob/master/docs/manual/routines.rst)


* * *
# Using the routines[](https://wger.readthedocs.io/en/latest/manual/routines.html#using-the-routines "Link to this heading")
...
## Workout days[](https://wger.readthedocs.io/en/latest/manual/routines.html#workout-days "Link to this heading")
...
## Advancing through the routine[](https://wger.readthedocs.io/en/latest/manual/routines.html#advancing-through-the-routine "Link to this heading")
...
## Sets and exercises[](https://wger.readthedocs.io/en/latest/manual/routines.html#sets-and-exercises "Link to this heading")
...
## Progression rules[](https://wger.readthedocs.io/en/latest/manual/routines.html#progression-rules "Link to this heading")
Note
...
[](https://wger.readthedocs.io/en/latest/index.html "Welcome to the wger 2.5 documentation") [Next ](https://wger.readthedocs.io/en/latest/production/docker.html "Docker compose")
* * *
